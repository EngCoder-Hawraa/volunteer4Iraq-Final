# Generated by Django 3.1.2 on 2021-12-28 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intities_pic', models.ImageField(default='building.png', upload_to='images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('comment_pic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='iraq.intity')),
